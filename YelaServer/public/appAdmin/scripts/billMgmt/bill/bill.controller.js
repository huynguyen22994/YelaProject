(function() {
    ...
    angular
        ...
        .controller('BillController', ControllerController);

    ControllerController.$inject = ['$scope', '$window', '$location', 'PagerService', 'BillService', 'ylConstant', '$mdDialog'];
    function ControllerController($scope, $window, $location, PagerService, BillService, ylConstant, $mdDialog) {
       var vm = this;
